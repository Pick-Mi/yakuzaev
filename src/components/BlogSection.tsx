...
const BlogSection = () => {
  ...
  return (
    <section className="w-full py-8 sm:py-10 md:py-[42px] px-4 sm:px-8 md:px-12 lg:px-[70px] overflow-hidden" style={{ backgroundColor: '#F8F9F9' }}>
      <div className="max-w-[1300px] mx-auto">
        <div className="flex flex-col gap-10 sm:gap-14 md:gap-[70px]">
          <h2 className="font-['Inter',sans-serif] font-medium text-[28px] sm:text-[36px] md:text-[48px] text-[#12141d]">
            Compelling reasons
          </h2>
          
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 md:gap-[40px] overflow-x-auto pb-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {blogs.map((blog) => (
              <div key={blog.id} className="bg-white w-full sm:w-[300px] md:w-[350px] lg:w-[407px] h-auto md:h-[388px] shrink-0 overflow-hidden">
          ...
          <div className="flex justify-center mt-6 sm:mt-8 md:mt-[46px]">
            <Link
              to="/blogs"
              className="bg-black h-[45px] sm:h-[50px] md:h-[55px] px-5 sm:px-6 md:px-[23px] py-[13px] flex items-center justify-center w-full sm:w-auto sm:min-w-[180px] md:w-[200px] rounded-none hover:bg-black/90 transition-colors"
            >
