...
const ProductHero = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col gap-5 items-center right-[70px] top-[610px] w-[289px] max-lg:left-5 max-lg:top-auto max-lg:bottom-10">
        ...
        <div className="flex gap-5 items-center w-full max-md:flex-col max-md:gap-4 max-md:w-full">
          ...
          <button
            onClick={onAddToCart}
            className="bg-white/5 flex gap-2.5 items-center justify-center overflow-hidden px-[23px] py-[13px] transition-all hover:bg-white/10 active:scale-95 max-md:w-full max-md:h-[50px]"
          >
      ...
      <div className="absolute flex flex-col gap-[35px] items-start left-[70px] top-[460px] w-[635px] max-lg:left-5 max-lg:right-5 max-lg:w-auto max-md:top-auto max-md:bottom-[200px]">
        ...
        <div className="flex gap-[50px] items-center max-md:gap-[30px] max-md:flex-wrap">
          ...
          <div className="flex flex-col gap-[13px] items-start font-['Inter'] font-medium leading-[0] text-white whitespace-nowrap">
            <div className="flex flex-col justify-center opacity-80 text-2xl">
              <p className="leading-normal whitespace-nowrap">{secondSpec?.value || range}</p>
            </div>
            <div className="flex flex-col justify-center opacity-70 text-sm">
              <p className="leading-normal whitespace-nowrap">{secondSpec?.label || "IDC Range"}</p>
            </div>
          </div>
